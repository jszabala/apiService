...
directorios = {
    ...
    "categorias":{
        ...
        "factuCre":os.path.dirname(os.path.abspath(__file__))+"/categorias/Facturas credito", 
        "factuDeb":os.path.dirname(os.path.abspath(__file__))+"/categorias/Facturas debito",
        "ordenPed":os.path.dirname(os.path.abspath(__file__))+"/categorias/Ordenes de pedido",
        "ordenRem":os.path.dirname(os.path.abspath(__file__))+"/categorias/Ordenes de remision",
        "epiCrisis":os.path.dirname(os.path.abspath(__file__))+"/categorias/Epi crisis",
        "histoCli":os.path.dirname(os.path.abspath(__file__))+"/categorias/Historias clinicas",
        "otro":os.path.dirname(os.path.abspath(__file__))+"/categorias/Sin clasificar",
